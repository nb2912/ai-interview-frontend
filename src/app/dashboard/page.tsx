...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-100 text-gray-800 font-sans">
      {/* Header */}
      <header className="bg-white/90 shadow-md backdrop-blur-md sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="relative" ref={profileRef}>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-xl z-30 animate-fade-in">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <section className="bg-gradient-to-r from-orange-500 to-red-600 text-white p-8 rounded-2xl shadow-md">
          <h2 className="text-2xl font-semibold mb-1">Welcome back, Nihal 👋</h2>
        ...
        <section className="bg-white/70 border border-orange-100 shadow-md backdrop-blur rounded-xl p-6">
          ...
          <label
            ...
            className="cursor-pointer flex items-center gap-3 text-orange-700 hover:text-orange-800 transition"
          >
        ...
        <section className="bg-white/80 border border-gray-100 rounded-xl shadow-lg">
          ...
          <div>
            {recentSessions.map((session) => (
              <div
                key={session.id}
                className="px-6 py-4 flex justify-between items-center hover:bg-orange-50 transition"
              >
