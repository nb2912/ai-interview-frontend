                  ...
                  <form className="space-y-4" onSubmit={handleSignIn}>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
